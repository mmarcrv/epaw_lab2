...
<div class="main-container">
    <div class="w3-card-4 w3-white">
        <div class="w3-container w3-blue">
            <h2>Registre (Jakarta Bean Validation)</h2>
        </div>
        ...
        <form id="registerForm" action="Register" method="POST" class="w3-container w3-padding-24">
            ...
            <p>
                ...
                <input class="w3-input w3-border" type="text" id="name" name="name" 
                       required minlength="5" value="${user.name}" 
                       title="L'usuari ha de tenir entre 5 i 20 caràcters."/>
            </p>
            ...
            <p>
                ...
                <input class="w3-input w3-border" type="password" id="confirmPassword" name="confirmPassword" 
                       required value="${user.password}" title="Les contrasenyes han de coincidir" />
            </p>

            <button type="submit" class="w3-button w3-blue w3-block w3-section w3-padding">Enviar Registre</button>
